...
# GTAA_5전략
포트폴리오를 5개의 자산으로 균등하게 나눈 후, 
매월 마지막 거래일에 10개월 이동 평균 이상으로 마감될 자산에 투자하고 10개월 이동평균선 아래에 종가가 있다면 그 부분은 현금보유

다음달 마지막 거래일까지 모든 포지션을 유지한다.
...
# 0 1 23-28 * 1-5 python3 /Users/TY/Documents/class101/Dynamic_Asset/Dynamic_Asset_GTAA5_KR.py 
...
#파일 경로입니다.
static_asset_tym_file_path = "/Users/TY/Documents/class101/Dynamic_Asset/Dynamic_Asset_GTAA5_KR.json"
try:
