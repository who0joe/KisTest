...
# 0 16 1-7 * 1-5 python3 /Users/TY/Documents/class101/Dynamic_Asset/Dynamic_Asset_VAA_A_US.py 
...
#파일 경로입니다.
static_asset_tym_file_path = "/Users/TY/Documents/class101/Dynamic_Asset/Dynamic_Asset_VAA_A_US.json"
try:
...
for stock_info in MyPortfolioList:
    ...
    #Now_Price = KisUS.GetCurrentPrice(stock_code)
