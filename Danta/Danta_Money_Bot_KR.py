...
CheckNewStock = dict()
#파일 경로입니다.
check_file_path = "/Users/TY/Documents/class101/KrStock_" + BOT_NAME + "_CheckNew.json"
...
if IsMarketOpen == True:
    ...
    if len(DantaDataList) < MaxStockCnt and CheckNewStock['IsCheck'] == 'N':
        ...
        #파일 경로입니다.
        korea_file_path = "/Users/TY/Documents/class101/KrTradingDataList.json"
        ...
        #파일 경로입니다.
        StockData_file_path = "/Users/TY/Documents/class101/KrStockDataList.json"
        ...
        for Stock_Info in FinalInvestStockList:
            ...
            if len(DantaDataList) < MaxStockCnt:
                ...
                if IsMarketOpen == True:
                    ...
                    MiddlePrice = (df['low'][-2] + df['high'][-2]) / 2.0
